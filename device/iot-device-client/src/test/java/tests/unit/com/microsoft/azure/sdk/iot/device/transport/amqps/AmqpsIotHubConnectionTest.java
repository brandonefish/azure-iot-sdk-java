...
public class AmqpsIotHubConnectionTest {
    ...
    private void setLatches(AmqpsIotHubConnection connection)
    {
        ...
        Map<String, CountDownLatch> deviceSessionCountDownLatchs = new HashMap<>();
        deviceSessionCountDownLatchs.put("someDevice", mockWorkerLinkLatch);
        Deencapsulation.setField(connection, "deviceSessionsOpenedLatchs", deviceSessionCountDownLatchs);
